...
Если у вас возникли вопросы как работает та или иная функция в сервисе, обратитесь к книге о GitFlic. В ней описан весь функционал сервиса и непонятные моменты регулярно перефразируются более подробно. Документ доступен по ссылке [https://docs.gitflic.ru](https://docs.gitflic.ru)

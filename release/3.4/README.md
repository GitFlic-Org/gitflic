...
* Верстку при отображении длинных названий коммитов и веток
* Мобильную верстку при просмотре изменений в файле
* Некорректную ошибку при попытке передачи репозитория
...
* Ошибку при создании проекта через админ-панель
* Переход по ссылке в профиль пользователя со страницы CI/CD
* Работу предопределенной переменной CI_REGISTRY_IMAGE
* Работу транспортного токена с выбранным набором прав
* Ссылку на проект в readme.md при создании проекта в команде или в компании

### Доработки по LDAP:

* Запись в логи большего количества ошибок
* Проверяем логин независимо от регистра
* Разрешили админу сервиса исправлять почту пользователям LDAP
* Исправили ошибки, которые дублировали учетные записи и ломали связанные
